                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="editForm{{ $category->id }}"
                                action="{{ route('editcategory', ['id' => $category->id]) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="section_id" id="section" class="form-select"
                                                required>
                                                @foreach ($sections as $section)
                                                    <option value="{{ $section->id }}" @if($section->id == $category->section_id) selected @endif>{{ $section->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="brand_id" id="brand" class="form-select" required>
                                                @foreach ($brands as $brand)
                                                    <option value="{{ $brand->id }}" @if($brand->id == $category->brand_id) selected @endif>{{ $brand->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.yajra_datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin-manage-category') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
